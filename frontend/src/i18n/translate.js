...
export function getCachedDictionary(code) {
...
export async function preloadDictionaries(codes) {
...
export function translateSync(language, key, params, fallback) {
