    ...
    return (_jsxs("div", { className: "noxel-app", "data-tier": tier, children: [_jsxs("header", { className: "noxel-header", children: [_jsxs("div", { className: "hdr-left", children: [_jsx(Link, { to: "/dashboard", "aria-label": t("dashboard.title"), style: {
                                    ...
                                    flex: "0 0 auto",
                                                        ...
                                                        m.key === activeKey ? "nx-card--active" : "",
                                                                    ...
                                                                    ].join(" "), children: m.status === "ready" ? "LIVE" : m.status.toUpperCase() })] }), _jsx("h3", { className: "nx-card__title", children: m.name }), _jsx("p", { className: "nx-card__text", children: m.promise }), m.external ? (_jsxs("a", { className: "nx-card__link", href: m.route, target: "_blank", rel: "noopener noreferrer", onClick: (e) => e.stopPropagation(), children: [t("dashboard.card.open"), " \u2197"] })) : (_jsx(Link, { className: "nx-card__link", to: m.route, onClick: (e) => e.stopPropagation(), children: t("dashboard.card.open") }))] }, m.key))) })] })] }), _jsxs("footer", { style: { borderTop: "1px solid rgba(255,255,255,0.08)", marginTop: 48, padding: "32px 0", textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.55)" }, children: [_jsx("p", { style: { maxWidth: 720, margin: "0 auto 16px", lineHeight: 1.6 }, children: "NOXEL360 connects NOXEL SEO, NOXEL Forge, and Nexus in one dashboard for search visibility, verified backlinks, and language intelligence." }), _jsxs("nav", { "aria-label": "Site links", style: { display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 16, marginBottom: 14 }, children: [_jsx("a", { href: "https://noxelseo.com", style: { color: "#3ddc84", textDecoration: "none" }, children: "NOXEL SEO" }), _jsx("a", { href: "https://noxelforge.com", style: { color: "#3ddc84", textDecoration: "none" }, children: "NOXEL Forge" }), _jsx(Link, { to: "/nexus", style: { color: "#3ddc84", textDecoration: "none" }, children: "NOXEL Nexus" }), _jsx("a", { href: "/learn", style: { color: "#3ddc84", textDecoration: "none" }, children: "Learn" }), _jsx(Link, { to: "/app/account", style: { color: "rgba(255,255,255,0.55)", textDecoration: "none" }, children: "Account" }), _jsx(Link, { to: "/privacy", style: { color: "rgba(255,255,255,0.55)", textDecoration: "none" }, children: "Privacy" }), _jsx(Link, { to: "/terms", style: { color: "rgba(255,255,255,0.55)", textDecoration: "none" }, children: "Terms" })] }), _jsx("p", { style: { margin: 0 }, children: "\u00A9 2026 NOXEL360. All rights reserved." })] })] })] })] }));
}
