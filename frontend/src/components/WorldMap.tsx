...
import NexusSubdivisionSelect, { type NexusSubdivision } from "./NexusSubdivisionSelect";
      ...
      <div className="noxel-panel">
        ...
        <ul className="noxel-list">
          ...
          <li>
            ...
            {selectedId && (
              <>
                <NexusSubdivisionSelect
                  countryName={entry?.countryName}
                  subdivisions={subdivisions}
                  onAccept={handleSubdivisionAccept}
                  onDecline={handleSubdivisionDecline}
                />
