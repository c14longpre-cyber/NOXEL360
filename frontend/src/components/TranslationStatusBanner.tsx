...
export default function TranslationStatusBanner() {
  ...
  if (isFullyTranslated || dismissed) return null;
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(90deg, rgba(112,42,165,0.12) 0%, rgba(60,222,106,0.08) 100%)",
        color: "white",
        fontSize: 13,
      }}
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ opacity: 0.75, marginTop: 2 }}>
          The interface is shown in English while a native-speaker translation
          is prepared.{" "}
          <a
            href="https://github.com/"
            target="_blank"
            rel="noreferrer"
            style={{ color: "rgb(60,222,106)", textDecoration: "underline" }}
          >
