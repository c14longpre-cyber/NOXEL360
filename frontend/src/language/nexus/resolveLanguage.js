...
export function resolveBestLanguage(countryIso2, subdivisionIso, userLanguages = [], defaultLang = "en") {
    const country = countryIso2
        ? COUNTRY_DATA[countryIso2.toLowerCase()]
        : null;
    const subdivisionLangs = subdivisionIso && SUBDIVISION_LANGUAGE_OVERRIDES[subdivisionIso]
